...
arcpy.management.CalculateField(content[1], "IND_muni", expression = "1", field_type = "LONG")

#Limpiar seleccion 
arcpy.management.SelectLayerByAttribute(content[1], "CLEAR_SELECTION")

#Hacer un switch para cambiar los otros valores
arcpy.management.SelectLayerByAttribute(content[1], where_clause = "IND_muni is NULL")

#Asignar valores a cuadras que no estan dentro del área de influencia}
arcpy.management.CalculateField(content[1], "IND_muni", expression = "0")